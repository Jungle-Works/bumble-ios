...
//
//    // MARK: - Properties
//    fileprivate var localFaye: MZFayeClient! = MZFayeClient(url: URL(string: BumbleConfig.shared.fayeBaseURLString))
...
//        }, failure: { (error) in
//            completion?(false)
//            BumbleConfig.shared.log.debug("error==>\(error?.localizedDescription ?? "")", level: .info)
...
//            BumbleConfig.shared.log.debug(message, level: .error)
...
//        BumbleConfig.shared.log.debug("didConnectTo==>\(url.absoluteString)", level: .info)
...
//        BumbleConfig.shared.log.debug("didDisconnectWithError==>\(errorMessage)", level: .info)
...
//        BumbleConfig.shared.log.debug("didUnsubscribeFromChannel==>\(channel ?? "")", level: .info)
//    }
//
//    func fayeClient(_ client: MZFayeClient!, didSubscribeToChannel channel: String!) {
//        BumbleConfig.shared.log.debug("didSubscribeToChannel==>\(channel ?? "")", level: .info)
...
//        BumbleConfig.shared.socketsFailed = true
//        let errorMessage = error?.localizedDescription ?? ""
//        BumbleConfig.shared.log.debug("didFailWithError==>\(errorMessage)", level: .info)
//        NotificationCenter.default.post(name: .fayeDisconnected, object: nil)
//    }
//
//    func fayeClient(_ client: MZFayeClient!, didFailDeserializeMessage message: [AnyHashable : Any]!, withError error: Error!) {
//        let errorMessage = error?.localizedDescription ?? ""
//        BumbleConfig.shared.log.debug("didFailDeserializeMessage==>\(message ?? [:]) \n and error==>\(errorMessage)", level: .info)
//    }
//
