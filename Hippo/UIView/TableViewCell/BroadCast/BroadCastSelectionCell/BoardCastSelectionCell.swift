...
class BoardCastSelectionCell: UITableViewCell {
    ...
    func setUpForTeamSelection() {
        ...
        cellLabel.text = manager?.selectedTeam?.tagName ?? BumbleConfig.shared.strings.selectTeamsString
    }
    ...
    func setUpForShowAgents() {
        ...
        cellLabel.text = BumbleConfig.shared.strings.showString.trimWhiteSpacesAndNewLine() + " " + BumbleConfig.shared.strings.displayNameForCustomers.trimWhiteSpacesAndNewLine() + countString
