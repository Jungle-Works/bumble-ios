...
//        sendButton.setTitleColor(HippoConfig.shared.theme.headerTextColor, for: .normal)
        sendButton.backgroundColor = BumbleConfig.shared.theme.themeTextcolor
        sendButton.setTitleColor(BumbleConfig.shared.theme.themeColor, for: .normal)
        sendButton.layer.cornerRadius = sendButton.frame.height / 2
        
//        previousMessagesButton.setTitleColor(HippoConfig.shared.theme.headerBackgroundColor, for: .normal)
        previousMessagesButton.setTitleColor(BumbleConfig.shared.theme.themeColor, for: .normal)
