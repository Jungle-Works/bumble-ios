...
//    @IBOutlet weak var timeLabel: So_CustomLabel!
    ...
    func setupBoxBackground(messageType: Int) {
        mainContentView.backgroundColor = BumbleConfig.shared.theme.recievingBubbleColor //HippoConfig.shared.theme.incomingChatBoxColor
...
//        }
    ...
    func adjustShadow() {
        ...
        shadowView.backgroundColor = BumbleConfig.shared.theme.chatBoxBorderColor
...
extension IncomingImageCell {
    func resetPropertiesOfIncomingCell() {
        ...
        retryButton.backgroundColor = BumbleConfig.shared.theme.backgroundColor
