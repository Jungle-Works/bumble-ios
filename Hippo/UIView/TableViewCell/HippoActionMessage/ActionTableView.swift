...
//        }
        ...
        tableView.isUserInteractionEnabled = BumbleConfig.shared.appUserType == .customer
...
//        bgView.backgroundColor = UIColor.outGoingMessageBoxColor
    ...
    private func adjustShadow() {
        ...
        self.shadowView.layer.cornerRadius = BumbleConfig.shared.theme.chatBoxCornerRadius
        self.shadowView.backgroundColor = BumbleConfig.shared.theme.chatBoxBorderColor
    }
