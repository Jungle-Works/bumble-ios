...
class LeadTableViewCell: MessageTableViewCell {
    ...
    private func setup() {
        ...
        tableView.layer.borderWidth = BumbleConfig.shared.theme.chatBoxBorderWidth
        tableView.layer.borderColor = BumbleConfig.shared.theme.chatBoxBorderColor.cgColor//HippoConfig.shared.theme.gradientTopColor.cgColor
        self.tableView.dataSource = self
        self.tableView.delegate = self
        
        bgView.backgroundColor = BumbleConfig.shared.theme.incomingChatBoxColor//HippoConfig.shared.theme.gradientBackgroundColor //
