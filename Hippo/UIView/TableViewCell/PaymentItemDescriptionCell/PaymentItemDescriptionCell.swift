...
//        self.backgroundColor = .clear
        ...
        priceLabel.textColor = BumbleConfig.shared.theme.broadcastTitleColor
        priceLabel.font = UIFont.regular(ofSize: 14)
        
        titleLabel.textColor = BumbleConfig.shared.theme.broadcastTitleColor
        titleLabel.font = UIFont.regular(ofSize: 14)
        
        descriptionLabel.textColor = BumbleConfig.shared.theme.broadcastTitleColor
        ...
        cancelIcon.backgroundColor = BumbleConfig.shared.theme.themeTextcolor//UIColor.themeColor
...
//        textviewPlaceHolderLabel.textColor = theme.label.secondary
    ...
    func setPickerView() {
        ...
        let doneButton = UIBarButtonItem(title: BumbleStrings.Done, style: UIBarButtonItem.Style.plain, target: self, action: #selector(prickerDoneButtonClicked))
