...
//        selectedChannelId = [Int]()
        ...
        chatStatusArray.append(labelWithId(label: BumbleStrings.openChat , id: 1, isSelected: true))
        chatStatusArray.append(labelWithId(label: BumbleStrings.closeChat, id: 2))
