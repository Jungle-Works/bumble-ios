...
extension NLevelViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func presentChatScreen(with message: String, supportId: Int) {
        ...
        BumbleConfig.shared.openChatScreen(withTransactionId: transctionId, tags: tag, channelName: channelName, message: message, userUniqueKey: id, isInAppMessage: true) { (success, error) in
