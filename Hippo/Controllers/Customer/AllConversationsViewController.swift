...
//        self.navigationController?.interactivePopGestureRecognizer?.delegate = self
        ...
        view_NavigationBar.title = config.title ?? BumbleConfig.shared.theme.headerText
...
//        self.navigationController?.interactivePopGestureRecognizer?.delegate = nil
    ...
    @IBAction func newConversationClicked(_ sender: Any) {
        var fuguNewChatAttributes = FuguNewChatAttributes(transactionId: "", userUniqueKey: BumbleConfig.shared.userDetail?.userUniqueKey, otherUniqueKey: nil, tags: HippoProperty.current.newConversationButtonTags, channelName: nil, preMessage: "", groupingTag: nil)
...
//        fuguNewChatAttributes.botGroupId = HippoProperty.current.newconversationBotGroupId//"72"//
   ...
   func uiSetup() {
    if BumbleConfig.shared.hasChannelTabs == true{
        self.buttonContainerViewHeightConstraint.constant = 45
        self.openChatButton.isHidden = !BumbleConfig.shared.hasChannelTabs
        self.closeChatButton.isHidden = !BumbleConfig.shared.hasChannelTabs
    }else{
...
//
        navigationBackgroundView.backgroundColor = BumbleConfig.shared.theme.headerBackgroundColor
...
//        }
    ...
    @IBAction func newConversationButtonClicked(_ sender: UIButton) {
        ...
        if sender.isSelected{
            ...
            var fuguNewChatAttributes = FuguNewChatAttributes(transactionId: "", userUniqueKey: BumbleConfig.shared.userDetail?.userUniqueKey, otherUniqueKey: nil, tags: nil, channelName: nil, preMessage: "", groupingTag: nil)
