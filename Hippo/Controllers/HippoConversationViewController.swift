...
//class BumbleConversationViewController: UIViewControll, PickerHelperDelegate, PickerHelperDelegateer {
//    //MARK: Constants
...
//                return true
//            }
//            errorMessage = BumbleStrings.enterSomeText
//            showErrorMessage()
...
//
//        tableViewChat.backgroundColor = BumbleConfig.shared.theme.backgroundColor
//
...
//        showAlertWith(message: BumbleStrings.noNetworkConnection) {
//            return
//        }
//    }
//
...
//    func setTitleButton() {
//
//        let color = BumbleConfig.shared.theme.headerTextColor
//        let button =  UIButton(type: .custom)
//        button.sizeToFit()
//        button.backgroundColor = UIColor.clear
//        button.setTitleColor(color, for: .normal)
//
//        button.titleLabel?.font = BumbleConfig.shared.theme.headerTextFont//
//
...
//extension BumbleConversationViewController: PickerHelperDelegate {
...
//            showAlert(title: "", message: result.error?.localizedDescription ?? BumbleStrings.somethingWentWrong, actionComplete: nil)
//            return
//        }
...
//                showAlert(title: "", message: BumbleStrings.somethingWentWrong, actionComplete: nil)
//                return
//            }
...
//        BumbleConfig.shared.UnhideJitsiView()
...
//extension BumbleConversationViewController: SelectImageViewControllerDelegate {
...
//extension BumbleConversationViewController {
//
...
//extension BumbleConversationViewController: RetryMessageUploadingDelegate {
...
//    }
//}
//extension BumbleConversationViewController: VideoCallMessageTableViewCellDelegate {
...
//extension BumbleConversationViewController: VideoTableViewCellDelegate {
...
//extension BumbleConversationViewController: DocumentTableViewCellDelegate {
...
//extension BumbleConversationViewController: SelfMessageDelegate {
//
...
//    }
//}
//extension BumbleConversationViewController: CreatePaymentDelegate {
...
//extension BumbleConversationViewController: NavigationTitleViewDelegate {
...
//    }
//}
//extension BumbleConversationViewController: CardMessageDelegate {
...
//extension BumbleConversationViewController: PaymentMessageCellDelegate {
...
//            case 0:
//                showAlertWith(message: BumbleStrings.noPaymentMethod, action: nil)
//            case 1:
...
//        let config = WebViewConfig(url: url, title: BumbleStrings.payment)
//        let vc = PrePaymentViewController.getNewInstance(config: config)
...
//            BumbleConfig.shared.log.error("cannot find selected card.... Please select the card", level: .error)
//            return
//        }
//
//        BumbleConfig.shared.delegate?.startLoading(message: "Redirecting to payment...")
//
...
//            BumbleConfig.shared.delegate?.stopLoading()
...
//                return
//            }
//            BumbleConfig.shared.log.debug("Response --\(result)", level: .response)
...
//extension BumbleConversationViewController: submitButtonTableViewDelegate
//{
...
//extension BumbleConversationViewController : UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
//
//
...
//            imageViewAttachment?.tintColor = BumbleConfig.shared.theme.moreOptionsIconsTintColor
//            labelAttachment?.tintColor = BumbleConfig.shared.theme.moreOptionsTitlesTintColor
//        }
//    }
//}
...
//extension BumbleConversationViewController : paymentCardPaymentOfCreatePaymentDelegate{
