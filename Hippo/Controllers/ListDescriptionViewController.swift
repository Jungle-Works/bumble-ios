...
class ListDescriptionViewController: UIViewController {
    ...
    func sendMessagesAndPop(with message: String) {
        ...
        let uniqueKey = BumbleConfig.shared.userDetail?.userUniqueKey ?? "-1"
    ...
    func getMessage(useTextView: Bool) -> String {
        var message = ""
        if let userId = BumbleConfig.shared.userDetail?.userUniqueKey {
            message += "[User ID: \(userId)]"
        }
        if BumbleConfig.shared.ticketDetails.transactionId != nil {
            message += "\n" + "[Transaction ID: \(BumbleConfig.shared.ticketDetails.transactionId!)]"
        }
        if !message.isEmpty {
            message += "\n"
        }
    ...
    func presentChatScreen(with message: String) {
        guard let id = BumbleConfig.shared.userDetail?.userUniqueKey else {
            return
        }
        ...
        let tags = [HippoSupportList.FAQName]
        BumbleConfig.shared.checkForIntialization { (success, error) in
            guard success else {
                return
            }
    ...
    func getTransactionId() -> String {
        var transctionId = BumbleConfig.shared.ticketDetails.transactionId ?? ""
    ...
    func getCustomAttributes() -> [String: Any] {
        ...
        if let phoneNo = BumbleConfig.shared.userDetail?.phoneNumber, phoneNo != "" {
    ...
    func setViewAsPerTheme() {
        ...
        self.callButton.backgroundColor = BumbleConfig.shared.theme.supportTheme.supportButtonThemeColor
        self.chatButton.backgroundColor = BumbleConfig.shared.theme.supportTheme.supportButtonThemeColor
        self.submitButton.backgroundColor = BumbleConfig.shared.theme.supportTheme.supportButtonThemeColor
        
        self.callButton.setTitleColor(BumbleConfig.shared.theme.supportTheme.supportButtonTitleColor, for: .normal)
        self.callButton.titleLabel?.font = BumbleConfig.shared.theme.supportTheme.supportButtonTitleFont
        
        self.chatButton.setTitleColor(BumbleConfig.shared.theme.supportTheme.supportButtonTitleColor, for: .normal)
        self.chatButton.titleLabel?.font = BumbleConfig.shared.theme.supportTheme.supportButtonTitleFont
        
        self.submitButton.setTitleColor(BumbleConfig.shared.theme.supportTheme.supportButtonTitleColor, for: .normal)
        self.submitButton.titleLabel?.font = BumbleConfig.shared.theme.supportTheme.supportButtonTitleFont
        
        self.subHeadingLabel.font = BumbleConfig.shared.theme.supportTheme.supportDescSubHeadingFont
        self.subHeadingLabel.textColor = BumbleConfig.shared.theme.supportTheme.supportDescSubHeadingColor
        
        self.descLabel.font = BumbleConfig.shared.theme.supportTheme.supportDescriptionFont
        self.descLabel.textColor = BumbleConfig.shared.theme.supportTheme.supportDescriptionColor
