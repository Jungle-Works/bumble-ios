...
//    }
    ...
    func setUpSearchBar() {
        ...
        textFieldInsideSearchBar1?.backgroundColor = BumbleConfig.shared.theme.searchBarBackgroundColor//HippoConfig.shared.theme.backgroundColor//
    }
...
//            let assignedAgentId = info.agentId
    ...
    func assignChatToAgent(agent: Agent) {
        guard let accessToken = BumbleConfig.shared.agentDetail?.fuguToken, let userId = agent.userId else {
            return
        }
