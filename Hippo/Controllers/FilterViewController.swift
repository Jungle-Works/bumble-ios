...
//        applyButtonHeightConstraint.constant = 0
        ...
        if BumbleConfig.shared.theme.crossBarButtonText.count > 0 {
            crossButton.setTitle((" " + BumbleConfig.shared.theme.crossBarButtonText), for: .normal)
            if BumbleConfig.shared.theme.crossBarButtonFont != nil {
                crossButton.titleLabel?.font = BumbleConfig.shared.theme.crossBarButtonFont
            }
