...
class MultipleSelectTableViewCell: UITableViewCell {
    ...
    internal func setTheme() {
        ...
        bgView.backgroundColor = BumbleConfig.shared.theme.multiselectUnselectedButtonColor //HippoConfig.shared.theme.chatBoxBorderColor
...
extension MultipleSelectTableViewCell {
    func set(button: MultiselectButtons)
    {
        ...
        if button.status!
        {
            ...
            self.selectionButtonView.tintColor = BumbleConfig.shared.theme.themeColor
            bgView.backgroundColor = BumbleConfig.shared.theme.multiselectSelectedButtonColor
        }
        else
        {
            let renderedImage = image?.withRenderingMode(.alwaysOriginal)
            self.selectionButtonView?.image = renderedImage
            bgView.backgroundColor = BumbleConfig.shared.theme.multiselectUnselectedButtonColor
