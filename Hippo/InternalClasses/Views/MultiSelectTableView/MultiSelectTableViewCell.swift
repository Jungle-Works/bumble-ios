...
class MultiSelectTableViewCell: UITableViewCell {
    ...
    private func setTheme() {
        ...
        bgView.backgroundColor = BumbleConfig.shared.theme.incomingChatBoxColor
    ...
    func setTime() {
        ...
        timeLabel.textColor = BumbleConfig.shared.theme.incomingMsgDateTextColor
    }
    ...
    func setName()
    {
        ...
        self.nameLabel.font = BumbleConfig.shared.theme.senderNameFont
        self.nameLabel.textColor = BumbleConfig.shared.theme.senderNameColor
    }
...
//            cell.cellButton.setTitleColor(.white, for: .normal)
            cell.cellButton.setTitleColor(BumbleConfig.shared.theme.headerTextColor, for: .normal)
