...
class HippoBroadcaster {
    ...
    private func getParamsForBroadcastMessage(with dict: [String: Any]) -> [String: Any]? {
        ...
        guard let fuguToken = BumbleConfig.shared.agentDetail?.fuguToken else {
            return nil
        }
    ...
    private func getParamsForGroupingTags() -> [String: Any]? {
        ...
        guard let fuguToken = BumbleConfig.shared.agentDetail?.fuguToken, !fuguToken.isEmpty else {
            return nil
        }
