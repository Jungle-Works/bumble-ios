...
class PromotionCellDataModel
{
    ...
    func calculateHeightForCell(title:String,description:String) -> CGFloat
    {
        ...
        let font = BumbleConfig.shared.theme.titleFont
        attributedTitleString.addAttribute(NSAttributedString.Key.font, value: font, range: range)
        attributedTitleString.addAttribute(NSAttributedString.Key.foregroundColor, value: BumbleConfig.shared.theme.titleTextColor, range: range)
        attributedTitleString.addAttribute(NSAttributedString.Key.paragraphStyle, value: style, range: range)
        
        let font2 = BumbleConfig.shared.theme.descriptionFont
        attributedDescriptionString.addAttribute(NSAttributedString.Key.font, value: font2, range: descRange)
        attributedDescriptionString.addAttribute(NSAttributedString.Key.foregroundColor, value: BumbleConfig.shared.theme.descriptionTextColor, range: descRange)
