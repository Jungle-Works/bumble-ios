...
class FormData: NSObject {
    ...
    private func setupColor() {
        backgroundColor = BumbleConfig.shared.theme.headerBackgroundColor //UIColor.hexStringToUIColor(hex: backgroundColorHexColor)
        titleColor = BumbleConfig.shared.theme.headerTextColor //UIColor.hexStringToUIColor(hex: titleColorHexColor)
    }
