...
class CustomAction: NSObject {
    ...
    attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: BumbleConfig.shared.theme.incomingMsgColor, range: range)
...
class MultiselectButtons: NSObject {
    ...
    func calculateHeightForButtons(btnTitle:String) -> CGFloat
    {
        ...
        let font = BumbleConfig.shared.theme.multiSelectButtonFont
        attributedString.addAttribute(NSAttributedString.Key.font, value: font, range: range)
       
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: BumbleConfig.shared.theme.multiSelectTextColor, range: range)
        attributedString.addAttribute(NSAttributedString.Key.paragraphStyle, value: style, range: range)
